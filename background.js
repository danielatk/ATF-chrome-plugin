...
$( document ).ready(function() {
    VERBOSITY='OUTPUT';      //DEBUG, WARNING, OUTPUT (default)
    savePageProfile=0;       //0:Nothing, 1:Save statistics, 2:Stats + Page profile, 3:Stats + Page profile + Timing, 4:Full log
    sendToServer=true;       //Default = true
    serverAddress='http://146.164.47.233:19282';        //Default = ''
    delay_to_calculate=1000; //In milliseconds
    hard_deadline=20000;     //Default = 20s
    mac='00:00:00:00:00:00'; //Default = '00:00:00:00:00:00'
    version = 1.40;
    stats = {};
    executed = false;
